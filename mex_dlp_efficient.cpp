...
vector_double solve_dc_nodewise(vertex_descriptor p,graph_t *g, double *params)
{
    	//     params=[num_nodes, label_vector_size, tol, maxIter, verbose, use_parallel_processing, num_processors, num_edges]
